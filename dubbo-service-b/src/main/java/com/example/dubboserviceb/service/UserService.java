package com.example.dubboserviceb.service;
...
import com.example.dubboserviceb.dao.UserMapper;
...
//        IPage<User> page = userMapper.selectPage(new Page<>(0, 5), new QueryWrapper<>());
        IPage<Map<String, Object>> page = userMapper.selectMapsPage(new Page<>(0, 4), new QueryWrapper<>());
